      ...
      <div className='flex flex-col space-y-10'>
        <div className='border-bottom py-5'>
          <div className="title-section">
            <h2>About Us</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae officiis perferendis iusto deserunt reprehenderit obcaecati modi natus hic atque laboriosam adipisci architecto nostrum tempore quam porro error, molestias ex libero.</p>
          </div>
        </div>

        <div>
          <div className="title-section">
            <h2>Company Milestone</h2>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Distinctio nihil eligendi quo!</p>
          </div>

          <ol id="timeline-milestore" className="relative border-s border-blue-300 dark:border-gray-700 max-w-xl mx-auto">
            <li className="mb-10 ms-4">
              <div className="bullet-point"></div>
              <time>February 2022</time>
              <h3>Application UI code in Tailwind CSS</h3>
              <p className="mb-4">Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages.</p>
            </li>
            <li className="mb-10 ms-4">
              <div className="bullet-point"></div>
            ...
            <div className="flex flex-col space-y-2 max-w-xl mx-auto">
              {
                members.map((member, index) => {
                  return (
                    <div key={index} className="items-center bg-blue-50 rounded-lg shadow flex dark:bg-gray-800 dark:border-gray-700">
                      <a href="#" className='w-52'>
                        <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={member.avatar} alt="Bonnie Avatar" />
                      </a>
                      <div className="p-5 w-full ">
                        <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                          <a href="#">{member.name}</a>
                        </h3>
                        <span className="text-gray-500 dark:text-gray-400">{member.jobTitle}</span>
                        <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{member.jobDescription}</p>
                        <ul className="flex space-x-4 sm:mt-0">
                          <li>
                            <a href="#" className="text-blue-400 hover:text-blue-500 dark:hover:text-blue-900">
